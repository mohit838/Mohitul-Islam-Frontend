      ...
      <div>
        ...
        <div>
          <p className="text-center text-lg font-medium">
            Hello, you can contact me via this contact form (currently disable
            due to securities issues) <br></br>or mail me at
            <a
              ...
              <g id="g14">
                <g id="g16">
                  ...
                  <g id="g170">
                    <path
                      id="path272"
                      d="M554.113 562.578h287.856C180.008 562.578 173.645 556.132 173.645 548.18V310.114C173.645 302.163 180.008 295.717 187.856 295.717H554.113C561.963 295.717 568.324 302.163 568.324 310.114V548.18C568.324 556.132 561.963 562.578 554.113 562.578Z"
                      fill="#060C37"
                    />
                  </g>
                  <g id="g174">
                  ...
                  <path
                    id="path282"
                    d="M535.104 552.722h291.254V305.564H535.104V552.722Z"
                    fill="#D8E9F5"
                  />
                  <path
                    id="path284"
                    d="M535.1 322.18h291.256V305.568H535.1V322.18Z"
                    fill="#A4B1BA"
                  />
                  <path
                    id="path286"
                    d="M201.252 320.17h296.898V314.56H201.252V320.17Z"
                    fill="#FF6044"
                  />
                  <path
                    id="path288"
                  ...
                  <g id="g356">
                    <path
                      id="path358"
                      d="M230.094 489.727h264.645C144.782 489.727 128.679 473.412 128.679 453.286C128.679 433.159 144.782 416.844 164.645 416.844h294.128C213.99 416.844 230.094 433.159 230.094 453.286V489.727Z"
                      fill="#FFBF69"
                    />
                  </g>
                  <g id="g360">
